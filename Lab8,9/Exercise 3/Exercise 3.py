...
# Drawing taskbar  
def taskBar():
    menu = pygame.image.load("Lab8,9\Exercise 3\Images\menu.png").convert_alpha()
    ...
    # Icon settings
    size1Image = pygame.image.load("Lab8,9\Exercise 3\Images\\1_size.png").convert_alpha()
    size1Image = pygame.transform.scale(size1Image, (20, 20))
    surface.blit(size1Image, (275, 5))
    
    size2Image = pygame.image.load("Lab8,9\Exercise 3\Images\\2_size.png").convert_alpha()
    size2Image = pygame.transform.scale(size2Image, (20, 20))
    surface.blit(size2Image, (295, 5))
    
    size3Image = pygame.image.load("Lab8,9\Exercise 3\Images\\3_size.png").convert_alpha()
    size3Image = pygame.transform.scale(size3Image, (20, 20))
    surface.blit(size3Image, (315, 5))
    
    lineImage = pygame.image.load("Lab8,9\Exercise 3\Images\drawline.png").convert_alpha()
    lineImage = pygame.transform.scale(lineImage, (20, 20))
    surface.blit(lineImage, (375, 5))

    rectImage = pygame.image.load("Lab8,9\Exercise 3\Images\\rect.png").convert_alpha()
    rectImage = pygame.transform.scale(rectImage, (30, 30))
    surface.blit(rectImage, (400, 0))

    squareImage = pygame.image.load("Lab8,9\Exercise 3\Images\square.png").convert_alpha()
    squareImage = pygame.transform.scale(squareImage, (30, 30))
    surface.blit(squareImage, (435, 0))

    circleImage = pygame.image.load("Lab8,9\Exercise 3\Images\circle.png").convert_alpha()
    circleImage = pygame.transform.scale(circleImage, (25, 25))
    surface.blit(circleImage, (470, 3))

    etrienImage = pygame.image.load("Lab8,9\Exercise 3\Images\etrien.png").convert_alpha()
    etrienImage = pygame.transform.scale(etrienImage, (27, 27))
    surface.blit(etrienImage, (500, 0))

    trienImage = pygame.image.load("Lab8,9\Exercise 3\Images\\trien.png").convert_alpha()
    trienImage = pygame.transform.scale(trienImage, (18, 25))
    surface.blit(trienImage, (532, 3))

    rhombusImage = pygame.image.load("Lab8,9\Exercise 3\Images\\rhombus.png").convert_alpha()
    rhombusImage = pygame.transform.scale(rhombusImage, (30, 30))
    surface.blit(rhombusImage, (555, 0))

    eraserImage = pygame.image.load("Lab8,9\Exercise 3\Images\eraser.png").convert_alpha()
